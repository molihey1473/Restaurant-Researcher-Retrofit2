...
public class OsakaSonotaAreaActivity extends AppCompatActivity implements ListView.OnItemClickListener {
    public static final String TAG = "Restaurants";
    private ServiceManager rManager;
    private List<Shop> shops;
    private String sonotaCode = "Y868";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_osaka_sonota_area);
        listView = (ListView)findViewById(R.id.listViewSonota);
        ...
        menu.findItem(R.id.city_menu_setting).setOnMenuItemClickListener(
                new MenuItem.OnMenuItemClickListener(){
                    ...
                    public boolean onMenuItemClick(MenuItem item){
                        Intent intent = new Intent(OsakaSonotaAreaActivity.this, OsakaArea.class);
                        startActivity(intent);
                        return true;
                    }
                }
