...
public class TennojiAreaActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    public static final String TAG = "Restaurants";
    private ServiceManager rManager;
    private List<Shop> shops;
    private String tennojiCode = "Y325";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tennoji_area);
        listView = (ListView)findViewById(R.id.listViewTennoji);
        ...
        menu.findItem(R.id.city_menu_setting).setOnMenuItemClickListener(
                new MenuItem.OnMenuItemClickListener(){
                    ...
                    public boolean onMenuItemClick(MenuItem item){
                        Intent intent = new Intent(TennojiAreaActivity.this, OsakaArea.class);
                        startActivity(intent);
                        return true;
                    }
                }
