...
public class MatsubaraAreaActivity extends AppCompatActivity implements ListView.OnItemClickListener {
    public static final String TAG = "Restaurants";
    private ServiceManager rManager;
    private List<Shop> shops;
    private String matsubaraCode = "Y358";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_matsubara_area);
        listView = (ListView)findViewById(R.id.listViewMatsubara);
        ...
        menu.findItem(R.id.city_menu_setting).setOnMenuItemClickListener(
                new MenuItem.OnMenuItemClickListener(){
                    ...
                    public boolean onMenuItemClick(MenuItem item){
                        Intent intent = new Intent(MatsubaraAreaActivity.this, OsakaArea.class);
                        startActivity(intent);
                        return true;
                    }
                }
