...
public class FukushimaAreaActivity extends AppCompatActivity implements ListView.OnItemClickListener {
    public static final String TAG = "Restaurants";
    private ServiceManager rManager;
    private List<Shop> shops;
    private String fukushimaCode = "Y301";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fukushima_area);
        listView = (ListView)findViewById(R.id.listViewFukushima);
        ...
        menu.findItem(R.id.city_menu_setting).setOnMenuItemClickListener(
                new MenuItem.OnMenuItemClickListener(){
                    ...
                    public boolean onMenuItemClick(MenuItem item){
                        Intent intent = new Intent(FukushimaAreaActivity.this, OsakaArea.class);
                        startActivity(intent);
                        return true;
                    }
                }
