...
public class KishiwadaAreaActivity extends AppCompatActivity implements ListView.OnItemClickListener {
    public static final String TAG = "Restaurants";
    private ServiceManager rManager;
    private List<Shop> shops;
    private String kishiwadaCode = "Y357";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kishiwada_area);
        listView = (ListView)findViewById(R.id.listViewKishiwada);
        ...
        menu.findItem(R.id.city_menu_setting).setOnMenuItemClickListener(
                new MenuItem.OnMenuItemClickListener(){
                    ...
                    public boolean onMenuItemClick(MenuItem item){
                        Intent intent = new Intent(KishiwadaAreaActivity.this, OsakaArea.class);
                        startActivity(intent);
                        return true;
                    }
                }
