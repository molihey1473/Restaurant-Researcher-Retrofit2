...
public class MinoAreaActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    public static final String TAG = "Restaurants";
    private ServiceManager rManager;
    private List<Shop> shops;
    private String minoCode = "Y998";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mino_area);
        listView = (ListView)findViewById(R.id.listViewMino);
        ...
        menu.findItem(R.id.city_menu_setting).setOnMenuItemClickListener(
                new MenuItem.OnMenuItemClickListener(){
                    ...
                    public boolean onMenuItemClick(MenuItem item){
                        Intent intent = new Intent(MinoAreaActivity.this, OsakaArea.class);
                        startActivity(intent);
                        return true;
                    }
                }
