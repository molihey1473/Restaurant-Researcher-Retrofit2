...
public class SekimeAreaActivity extends AppCompatActivity implements ListView.OnItemClickListener {
    public static final String TAG = "Restaurants";
    private ServiceManager rManager;
    private List<Shop> shops;
    private String sekimeCode = "Y328";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sekime_area);
        listView = (ListView)findViewById(R.id.listViewSekime);
        ...
        menu.findItem(R.id.city_menu_setting).setOnMenuItemClickListener(
                new MenuItem.OnMenuItemClickListener(){
                    ...
                    public boolean onMenuItemClick(MenuItem item){
                        Intent intent = new Intent(SekimeAreaActivity.this, OsakaArea.class);
                        startActivity(intent);
                        return true;
                    }
                }
