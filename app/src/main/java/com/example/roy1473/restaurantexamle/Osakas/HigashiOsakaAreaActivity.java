package com.example.roy1473.restaurantexamle.Osakas;
...
import com.example.roy1473.restaurantexamle.DetailActivity;
import com.example.roy1473.restaurantexamle.Models.GourmetData;
import com.example.roy1473.restaurantexamle.Models.ServiceManager;
import com.example.roy1473.restaurantexamle.Models.Shop;
import com.example.roy1473.restaurantexamle.OsakaArea;
...
public class HigashiOsakaAreaActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    public static final String TAG = "Restaurants";
    private ServiceManager rManager;
    private List<Shop> shops;
    private String higashiOsakaCode = "Y361";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_higashi_osaka_area);
        listView = (ListView)findViewById(R.id.listViewHigashiOsaka);
        ...
        menu.findItem(R.id.city_menu_setting).setOnMenuItemClickListener(
                new MenuItem.OnMenuItemClickListener(){
                    ...
                    public boolean onMenuItemClick(MenuItem item){
                        Intent intent = new Intent(HigashiOsakaAreaActivity.this, OsakaArea.class);
                        startActivity(intent);
                        return true;
                    }
                }
