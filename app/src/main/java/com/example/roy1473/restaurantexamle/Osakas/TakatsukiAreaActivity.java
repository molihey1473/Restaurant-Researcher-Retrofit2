...
public class TakatsukiAreaActivity extends AppCompatActivity implements ListView.OnItemClickListener {
    public static final String TAG = "Restaurants";
    private ServiceManager rManager;
    private List<Shop> shops;
    private String takatsukiCode = "Y355";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_takatsuki_area);
        listView = (ListView)findViewById(R.id.listViewTakatsuki);
        ...
        menu.findItem(R.id.city_menu_setting).setOnMenuItemClickListener(
                new MenuItem.OnMenuItemClickListener(){
                    ...
                    public boolean onMenuItemClick(MenuItem item){
                        Intent intent = new Intent(TakatsukiAreaActivity.this, OsakaArea.class);
                        startActivity(intent);
                        return true;
                    }
                }
