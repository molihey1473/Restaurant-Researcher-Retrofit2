...
public class IbarakiAreaActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    public static final String TAG = "Restaurants";
    private ServiceManager rManager;
    private List<Shop> shops;
    private String ibarakiCode = "Y356";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ibaraki_area);
        listView = (ListView)findViewById(R.id.listViewIbaraki);
        ...
        menu.findItem(R.id.city_menu_setting).setOnMenuItemClickListener(
                new MenuItem.OnMenuItemClickListener(){
                    ...
                    public boolean onMenuItemClick(MenuItem item){
                        Intent intent = new Intent(IbarakiAreaActivity.this, OsakaArea.class);
                        startActivity(intent);
                        return true;
                    }
                }
