...
public class KyobashiAreaActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    public static final String TAG = "Restaurants";
    private ServiceManager rManager;
    private List<Shop> shops;
    private String kyobashiCode = "Y310";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kyobashi_area);
        listView = (ListView)findViewById(R.id.listViewKyobashi);
        ...
        menu.findItem(R.id.city_menu_setting).setOnMenuItemClickListener(
                new MenuItem.OnMenuItemClickListener(){
                    ...
                    public boolean onMenuItemClick(MenuItem item){
                        Intent intent = new Intent(KyobashiAreaActivity.this, OsakaArea.class);
                        startActivity(intent);
                        return true;
                    }
                }
