...
public class OsakaCityAreaActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    public static final String TAG = "Restaurants";
    private ServiceManager rManager;
    private List<Shop> shops;
    private String osakaCityCode = "Y329";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_osaka_city_area);
        listView = (ListView)findViewById(R.id.listViewOsakaCity);
        ...
        menu.findItem(R.id.city_menu_setting).setOnMenuItemClickListener(
                new MenuItem.OnMenuItemClickListener(){
                    ...
                    public boolean onMenuItemClick(MenuItem item){
                        Intent intent = new Intent(OsakaCityAreaActivity.this, OsakaArea.class);
                        startActivity(intent);
                        return true;
                    }
                }
