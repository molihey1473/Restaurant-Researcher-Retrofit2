...
public class TsuruhashiAreaActivity extends AppCompatActivity implements ListView.OnItemClickListener {
    public static final String TAG = "Restaurants";
    private ServiceManager rManager;
    private List<Shop> shops;
    private String tsuruhashiCode = "Y326";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tsuruhashi_area);
        listView = (ListView)findViewById(R.id.listViewTsuruhashi);
        ...
        menu.findItem(R.id.city_menu_setting).setOnMenuItemClickListener(
                new MenuItem.OnMenuItemClickListener(){
                    ...
                    public boolean onMenuItemClick(MenuItem item){
                        Intent intent = new Intent(TsuruhashiAreaActivity.this, OsakaArea.class);
                        startActivity(intent);
                        return true;
                    }
                }
